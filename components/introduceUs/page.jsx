...
const IntroducePage = () => {
    return (
        <div className="bg-white py-20">
            <div className="max-w-6xl mx-auto sticky top-[128px]">
                <div className="w-[815px]">
                    <h1 className="text-[64px] font-semibold leading-20 text-[#1A1E26] ">WHAT MAKES US THE <span className="text-yellow-500"> #1 </span> ONLINE ANANTA DISPENSARY IN INDIA?</h1>
            ...
            <div className="bg-white max-w-6xl mx-auto flex gap-5 sticky top-[128px] ">
                <div className="w-[389px] h-[375px] p-10  border rounded-xl shadow-lg ">
            ...
            <div className=" max-w-6xl mx-auto flex mt-10 gap-5 sticky top-[128px]">
                <div className="w-[389px] h-[375px] bg-white p-10  border rounded-xl shadow-lg">
